...
<head>
    ...
    <title>GinecoReport - Directorio Médico y Salud Ginecológica</title>
...
<body>
    ...
    <!-- Header / Navbar -->
    <nav class="navbar navbar-expand-lg navbar-gineco sticky-top py-3">
        <div class="container">
            <a class="navbar-brand fs-3" href="#">
                <i class="bi bi-heart-pulse-fill me-2" style="color: #c28fd6;"></i>Gineco<span>Report</span>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-lg-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link px-3" href="#busqueda">Especialistas</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item ms-lg-2">
                        @if (Route::has('login'))
                            @auth
                                <a href="{{ url('/dashboard') }}" class="btn btn-primary-gineco">Mi Panel</a>
                            @else
                                <a href="{{ route('login') }}" class="btn btn-outline-gineco me-2">Ingresar</a>
                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="btn btn-primary-gineco">Registrarse</a>
                                @endif
                            @endauth
                        @endif
                    </li>
