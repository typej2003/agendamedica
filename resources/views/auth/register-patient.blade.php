...
<head>
    ...
    <title>{{ config('app.name', 'GinecoReport') }} | Registro Paciente</title>
    ...
    <div class="container d-flex justify-content-center align-items-center py-5">
        <div class="card register-card p-4 p-md-5">
            ...
            <div class="text-center mb-4">
                ...
                <p class="text-muted small mt-2">Registro Paciente</p>
            </div>
            ...
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="row g-3">
                    ...
                    <!-- Género -->
                    <div class="col-12 col-md-3">
                        <label for="gender" class="form-label small fw-bold" style="color: var(--dark-color);">* Género:</label>
                        <div class="input-group">
